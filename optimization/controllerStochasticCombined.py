...
class OptControllerStochasticCombination(ControllerBase):
    ...
    def optimize(self, action_handle_map, count, optsolver, solver_manager):
        while not self.redisDB.get_bool(self.stop_signal_key) and not self.stopRequest.isSet():
            ...
            for timestep in reversed(range(0, self.horizon_in_steps)):
                ...
                for combination in ess_vac_product:
                    ...
                    try:
                        ...
                        if self.single_ev:
                            inst = Instance(str(instance_id), ini_ess_soc, ini_vac_soc, position, instance)
                        else:
            ...
            p_ess = Decision[0, initial_ess_soc_value, initial_vac_soc_value, recharge_value]['ESS']
            p_vac = Decision[0, initial_ess_soc_value, initial_vac_soc_value, recharge_value]['VAC']
            p_ev = {}

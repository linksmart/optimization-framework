...
class Model:
    ...
    def objrule1(model):
        ...
        if model.Recharge == 0:
            ...
            #vacSoC = model.final_ev_soc if model.final_ev_soc >= model.VAC_States_Min else model.VAC_States_Min
            ...
            """for p_ess, p_vac in product(model.Feasible_ESS_Decisions, model.Feasible_VAC_Decisions):
                ...
                valueOf_home = model.Value[(essSoC, model.final_ev_soc, 1)]  # +penalty_for_negative_soc_home    #Value of having fin_ess_soc,fin_ev_soc and home position in next time interval
                valueOf_away = model.Value[(essSoC, model.final_ev_soc, 0)]  # +penalty_for_negative_soc_away    #Value of having fin_ess_soc,fin_ev_soc and away position in next time interval

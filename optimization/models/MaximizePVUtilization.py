...
class MaximizePVUtilization():
    ...
    def __init__(self):
        ...
        ###########################################################################
        def obj_rule(model):  
            return sum(model.P_PV_Forecast[t]*model.P_PV_Forecast[t]-model.P_PV_Output[t]*model.P_PV_Output[t]-model.Q_PV_Output[t]*model.Q_PV_Output[t] for t in model.T)

...
class Model:
    ...
    model.P_PV = Var(bounds=(0, model.P_PV_Forecast))
    ...
    def combinatorics(model):
        ...
        return 1 == sum(model.Decision[ess, vac] for ess, vac in product(model.Feasible_ESS_Decisions, model.Feasible_VAC_Decisions))
    ...
    def objrule1(model):
        ...
        return model.P_PV_Forecast-model.P_PV + future_cost
